...
public class RecipeRegistry implements IRecipeRegistry {
    ...
    private static ImmutableMap<Class, IRecipeHandler> buildRecipeHandlersMap(
    ...
    private void addRecipeUnchecked(@Nonnull Object recipe, IRecipeCategory recipeCategory,
    ...
    @Nonnull
    @Override
    public ImmutableList<Object> getRecipesWithInput(@Nullable IRecipeCategory recipeCategory,
