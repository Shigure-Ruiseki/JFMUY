...
public interface IModRegistry {
     ...
     * Recipes added here that already implement {@link ruiseki.jfmuy.api.recipe.IRecipeWrapper} do not need to add a
     * handler.
     *
     * @since JEI 4.3.0
     */
     ...
     * Recipes that already implement {@link ruiseki.jfmuy.api.recipe.IRecipeWrapper} do not need to add a handler here.
     *
     * @param recipeClass          the recipe class being handled.
     * @param recipeWrapperFactory turns recipes into recipe wrappers.
     * @param recipeCategoryUid    a unique category id. For vanilla category IDs, see
     *                             {@link ruiseki.jfmuy.api.recipe.VanillaRecipeCategoryUid}.
     * @since JEI 4.3.0
     */
