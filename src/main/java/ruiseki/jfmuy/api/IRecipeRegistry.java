...
public interface IRecipeRegistry {
     ...
     *                          See {@link ruiseki.jfmuy.api.recipe.VanillaRecipeCategoryUid} for vanilla recipe
     *                          category UIDs.
     * @return the {@link IRecipeWrapper} for this recipe. returns null if the recipe cannot be handled by JEI or its
     *         addons.
     */
    @Nullable
     ...
     * @see ruiseki.jfmuy.api.recipe.transfer.IRecipeTransferRegistry
     */
    @Nullable
