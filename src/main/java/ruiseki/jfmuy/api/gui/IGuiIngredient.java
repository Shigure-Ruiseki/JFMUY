 ...
 * Useful for implementing {@link ruiseki.jfmuy.api.recipe.transfer.IRecipeTransferHandler} and some other advanced
 * cases.
...
public interface IGuiIngredient<T> {
     ...
     * purposes.
     *
     * @see ruiseki.jfmuy.api.recipe.transfer.IRecipeTransferHandlerHelper#createUserErrorForSlots(String,
