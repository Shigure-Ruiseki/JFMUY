 ...
 * Register a {@link IGuiScreenHandler} with JEI by using
...
public interface IGuiScreenHandler<T extends GuiScreen> extends Function<T, IGuiProperties> {
     ...
     * <p>
     * This is useful for screens that don't have normal slots (which is how JEI normally detects items under the
     * mouse).
     * <p>
