...
public interface IIngredients {
     ...
     *
     * @param ingredientType The type of ingredient: {@link VanillaTypes#ITEM}, {@link VanillaTypes#FLUID}, etc
     * @param inputs         The outer list represents the slot, the inner list is a rotating list of ingredients in
     *                       that slot.
     * @since JEI 4.12.0
     */
     ...
     *
     * @param ingredientType The type of ingredient: {@link VanillaTypes#ITEM}, {@link VanillaTypes#FLUID}, etc
     * @param outputs        The outer list represents the slot, the inner list is a rotating list of ingredients in
     *                       that slot.
     * @since JEI 4.12.0
     */
