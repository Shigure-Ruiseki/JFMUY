 ...
 *
 * This is given to your {@link ruiseki.jfmuy.api.IModPlugin#registerIngredients(IModIngredientRegistration)}.
 *
 * @since JEI 3.11.0
 */
public interface IModIngredientRegistration {
     ...
     * @param ingredientHelper   The ingredient helper to allows JEI to get information about ingredients for searching
     *                           and other purposes.
