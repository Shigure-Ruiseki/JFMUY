...
public final class VanillaRecipeCategoryUid {
     ...
     * {@link PotionHelper#isReagent(ItemStack)}.
     ...
     * {@link IVanillaRecipeFactory#createAnvilRecipe(ItemStack, List, List)}
     *
     * @since JEI 4.2.6
     */
     ...
     * {@link IModRegistry#addIngredientInfo(Object, Class, String...)} or
     * {@link IModRegistry#addIngredientInfo(List, Class, String...)}
     *
     * @since JEI 4.5.0
     */
