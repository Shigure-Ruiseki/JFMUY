 ...
 * area.
 * Get the instance from {@link ruiseki.jfmuy.api.IModRegistry#getRecipeTransferRegistry()}.
 * <p>
 * To get registered recipe transfer handlers at runtime, see
 * {@link ruiseki.jfmuy.api.IRecipeRegistry#getRecipeTransferHandler(Container, ruiseki.jfmuy.api.recipe.IRecipeCategory)}
 */
