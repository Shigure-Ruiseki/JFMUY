...
public class RecipeBookmarkItem<I> extends BookmarkItem<I> {
    ...
    private static boolean addRecipeOutput(List<RecipeBookmarkItem<?>> outputs, Object ingredient,
        IRecipeWrapper recipe, IRecipeCategory<?> category, Ingredients ingredients) {
