...
import ruiseki.jfmuy.gui.TickTimer;
...
public class DrawableAnimated implements IDrawableAnimated {
    ...
    public DrawableAnimated(IDrawableStatic drawable, int ticksPerCycle,
        ...
        if (animationStartDirection == IDrawableAnimated.StartDirection.TOP
            || animationStartDirection == IDrawableAnimated.StartDirection.BOTTOM) {
