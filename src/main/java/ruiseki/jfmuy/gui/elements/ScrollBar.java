...
public class ScrollBar {
     ...
     */
    public ScrollResult startDrag(int mouseX, int mouseY, int visibleAmount, int hiddenAmount, float scrollOffsetY) {
     ...
     * @return the updated scroll offset
     */
    public ScrollResult scroll(int mouseX, int mouseY, double scrollDelta, int visibleAmount, int hiddenAmount,
        float scrollOffsetY) {
    ...
    static Rectangle calculateMarkerArea(Rectangle area, int visibleAmount, int hiddenAmount, float scrollOffsetY) {
        ...
        return new Rectangle(area.x + BORDER_SIZE, area.y + BORDER_SIZE + markerY, trackWidth, markerHeight);
    }

    /**
     * Calculate scroll offset from marker position.
     */
    private static float calculateScrollOffsetY(Rectangle area, Rectangle markerArea, double markerTopY,
