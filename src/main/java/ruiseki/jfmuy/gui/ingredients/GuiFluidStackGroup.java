...
public class GuiFluidStackGroup extends GuiIngredientGroup<FluidStack, GuiIngredient<FluidStack>>
    ...
    public void init(int slotIndex, boolean input, int xPosition, int yPosition, int width, int height, int capacityMb,
        ...
        GuiIngredient<FluidStack> guiIngredient = new GuiIngredient<>(
            renderer,
            helper,
            slotIndex,
            input,
