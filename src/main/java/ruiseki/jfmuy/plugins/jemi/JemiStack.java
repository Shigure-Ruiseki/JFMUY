...
public class JemiStack<T> extends EmiStack {
    ...
    public JemiStack(IIngredientType<T> type, IIngredientHelper<T> helper, IIngredientRenderer<T> renderer,
        T ingredient) {
        this.type = type;
        this.helper = helper;
    ...
    public List<Text> getTooltipText() {
        return renderer.getTooltip(Minecraft.getMinecraft(), ingredient, TooltipType.BASIC.isAdvanced())
            .stream()
            .map(EmiPort::literal)
    ...
    public List<TooltipComponent> getTooltip() {
        ...
        List<String> tooltip = renderer.getTooltip(client, ingredient, client.gameSettings.advancedItemTooltips);
