...
public class JemiRecipeLayoutBuilder implements IRecipeLayout {
    ...
    public static class Group<T> implements IGuiIngredientGroup<T> {
        ...
        public void init(int slotIndex, boolean input, IIngredientRenderer<T> ingredientRenderer, int x, int y,
            ...
            JemiRecipeSlotBuilder builder = new JemiRecipeSlotBuilder(
                input ? RecipeIngredientRole.INPUT : RecipeIngredientRole.OUTPUT,
                x,
                y);
    ...
    public static class FluidGroup extends Group<FluidStack> implements IGuiFluidStackGroup {
        ...
        public void init(int slotIndex, boolean input, int x, int y, int width, int height, int capacityMb,
            ...
            init(
                slotIndex,
                input,
                new FluidStackRenderer(capacityMb, showCapacity, width, height, overlay),
                x,
                y,
                width,
                height,
