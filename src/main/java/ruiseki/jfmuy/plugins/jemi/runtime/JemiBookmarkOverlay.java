...
// EmiStackInteraction stack = EmiScreenManager.getHoveredStack(EmiScreenManager.lastMouseX,
// EmiScreenManager.lastMouseY, false);
// if (stack instanceof EmiScreenManager.SidebarEmiStackInteraction sesi && sesi.getType() == SidebarType.FAVORITES &&
// sesi.getStack().getEmiStacks().size() == 1) {
