...
public class ModularUIProperties implements IGuiProperties {
    ...
    public ModularUIProperties(IMuiScreen screen) {
        Area mainArea = screen.getScreen()
            .getMainPanel()
            .getArea();
        Area screenArea = screen.getScreen()
            .getScreenArea();
        this.guiClass = screen.getGuiScreen()
            .getClass();
    ...
    public String toString() {
        return new ToStringBuilder(this).append("x", getGuiLeft())
            .append("y", getGuiTop())
    ...
    public boolean equals(Object o) {
        ...
        return guiLeft == that.guiLeft && guiTop == that.guiTop
            && guiXSize == that.guiXSize
            && guiYSize == that.guiYSize
            && screenWidth == that.screenWidth
            && screenHeight == that.screenHeight
            && Objects.equals(guiClass, that.guiClass);
    }
