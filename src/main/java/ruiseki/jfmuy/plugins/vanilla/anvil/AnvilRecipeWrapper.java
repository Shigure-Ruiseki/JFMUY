...
public class AnvilRecipeWrapper implements IRecipeWrapper {
    ...
    public void drawInfo(Minecraft minecraft, int recipeWidth, int recipeHeight, int mouseX, int mouseY) {
        ...
        ItemStack newLeftStack = currentIngredients.get(0)
            .getDisplayedIngredient();
        ItemStack newRightStack = currentIngredients.get(1)
            .getDisplayedIngredient();
        ...
        if (lastCost != 0) {
            ...
            String text = StatCollector.translateToLocalFormatted("container.repair.cost", costText);

            int mainColor = 0xFF80FF20;
            EntityPlayerSP player = minecraft.thePlayer;
            if (player != null && (lastCost >= 40 || lastCost > player.experienceLevel)
