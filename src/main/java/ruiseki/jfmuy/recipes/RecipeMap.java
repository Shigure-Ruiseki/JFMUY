...
public class RecipeMap {
    ...
    public <T extends IRecipeWrapper> void addRecipe(T recipeWrapper, IRecipeCategory<T> recipeCategory,
        Map<IIngredientType, List> ingredientsByType) {
    ...
    private <T extends IRecipeWrapper, V> void addRecipe(T recipeWrapper, IRecipeCategory<T> recipeCategory,
        IIngredientType<V> ingredientType, List<V> ingredients) {
