...
import ruiseki.jfmuy.ingredients.IngredientFilterBackgroundBuilder;
...
public class MemoryHogElementSearch implements IElementSearch {
    ...
    public void registerPrefix(PrefixInfo prefixInfo) {
        ...
        final PrefixedSearchable<GeneralizedSuffixTree> prefixedSearchable = new PrefixedSearchable<>(
            searchable,
            prefixInfo);
