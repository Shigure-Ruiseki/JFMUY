package ruiseki.jfmuy.search.bakedsubstring;
...
public final class BakedSubstringIndex<T> {
    ...
    private BakedSubstringIndex(String[] keys, Object[] values, Long2ObjectOpenHashMap<int[]> entriesByGram,
    ...
    public static final class Builder<T> {
        ...
        private static void addGrams(Long2ObjectOpenHashMap<IntArrayList> entriesByGram,
            Long2IntOpenHashMap lastEntryByGram, String key, int entryIndex) {
