        ...
        for (Integer slotNumber : slotNumbers) {
            if (slotNumber >= 0 && slotNumber < container.inventorySlots.size()) {
                ...
                if (slotStack.getItem() == itemStack.getItem()) {
                    ...
                    int targetDamage = itemStack.getItemDamage();
                    if (targetDamage == OreDictionary.WILDCARD_VALUE || targetDamage == slotStack.getItemDamage()) {

                        if (ItemStack.areItemStackTagsEqual(itemStack, slotStack)) {
                            return slot;
                        }
                    }
                }
