...
public class StackUtil {
    ...
    @Nullable
    public static ItemStack containsStack(@Nullable Iterable<ItemStack> stacks,
        @Nullable Iterable<ItemStack> contains) {
    ...
    public static String getUniqueIdentifierForStack(@Nonnull ItemStack stack, boolean wildcard) {
        ...
        StringBuilder itemKey = new StringBuilder(itemNameString).append(':')
            .append(metadata);
    ...
    public static List<String> getUniqueIdentifiersWithWildcard(@Nonnull ItemStack itemStack) {
        return Arrays
            .asList(getUniqueIdentifierForStack(itemStack, false), getUniqueIdentifierForStack(itemStack, true));
    }
    ...
    private static NBTTagCompound cleanNbt(NBTTagCompound nbtTagCompound) {
        ...
        Set<String> ignoredKeys = Internal.getHelpers()
            .getNbtIgnoreList()
            .getIgnoredNbtTags(keys);
