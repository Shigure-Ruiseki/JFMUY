package ruiseki.jfmuy.util.color;
...
public class ColorThief {
     ...
     */
    @Nullable
    public static int[] getColor(@NotNull BufferedImage sourceImage) {
     ...
     */
    @Nullable
    public static int[] getColor(@NotNull BufferedImage sourceImage, int quality, boolean ignoreWhite) {
     ...
     */
    @Nullable
    public static int[][] getPalette(@NotNull BufferedImage sourceImage, int colorCount) {
     ...
     */
    @Nullable
    public static int[][] getPalette(@NotNull BufferedImage sourceImage, int colorCount, int quality,
        boolean ignoreWhite) {
     ...
     */
    @Nullable
    public static MMCQ.CMap getColorMap(@NotNull BufferedImage sourceImage, int colorCount) {
     ...
     */
    @Nullable
    public static MMCQ.CMap getColorMap(@NotNull BufferedImage sourceImage, int colorCount, int quality,
        boolean ignoreWhite) {
        int[][] pixelArray;
     ...
     */
    @NotNull
    private static int[][] getPixelsFast(@NotNull BufferedImage sourceImage, int quality, boolean ignoreWhite) {
     ...
     */
    @NotNull
    private static int[][] getPixelsSlow(@NotNull BufferedImage sourceImage, int quality, boolean ignoreWhite) {
