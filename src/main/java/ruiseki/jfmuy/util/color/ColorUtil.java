...
public class ColorUtil {
     ...
     */
    public static double fastPerceptualColorDistanceSquared(@NotNull int[] color1, @NotNull int[] color2) {
     ...
     */
    public static double slowPerceptualColorDistanceSquared(@NotNull int[] color1, @NotNull int[] color2) {
    ...
    public static double slowPerceptualColorDistanceSquared(@NotNull Color color1, @NotNull Color color2) {
